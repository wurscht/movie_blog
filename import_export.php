...
<form method="post" action="">
    <input type='submit' class='btn btn-primary col-sm-6 offset-md-3 import' name='import' value='import' />
    <input type='submit' class='btn btn-primary col-sm-6 offset-md-3' name='export' value='export' />
</form>